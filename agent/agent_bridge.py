...
LOG_FILE    = str(SHARED / "sched_log.txt")    # xv6 scheduler log producer writes here
ADVICE_FILE = str(SHARED / "llm_advice.txt")   # this agent appends scheduling advice here

# Make sure the shared folder and advice file exist so other tools can tail them.
...
class LLMSchedulerAgent:
    ...
    def run(self):
        ...
        Steps:
          ...
          - Append ADVICE line to advice file for consumers to read.
        """
